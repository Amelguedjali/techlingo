...
class inside_a_domain_2 extends StatefulWidget {
  const inside_a_domain_2({Key? key}) : super(key: key);

  @override
  State<inside_a_domain_2> createState() => _inside_a_domain_2State();
}

class _inside_a_domain_2State extends State<inside_a_domain_2> {
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 123,),
    IconButton(
    icon: Icon(Icons.lock_open_outlined, color: color5),onPressed: () {
    Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => const start_for_a_new_user()),
    );
    },)
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 121,),
    IconButton(
    icon: Icon(Icons.lock_outlined, color: color5),onPressed: () {
    Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => const start_for_a_new_user()),
    );
